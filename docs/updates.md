...
* Texten [Att använda verktyget](https://libris.kb.se/katalogisering/help/use-the-editor) har uppdaterats med informaion om verks- och instanstyp för strömmande ljudbok med anledning av version 1.33 av Libris katalogisering.
* Texten [Verk](https://libris.kb.se/katalogisering/help/workflow-work) uppdaterad med anledning av nyheter för Medverkan och funktion.
* Texten [Instans](https://libris.kb.se/katalogisering/help/workflow-instance) uppdaterad med anledning av nyheter för Medverkan och funktion.
...
2022-03-30
</br>Nytt i samband med version 1.25 av Libris katalogisering:
* Ny sida för handskrifter med hänvisning till anvisningarna i Metadatabyrån: [Handskrifter](https://libris.kb.se/katalogisering/help/workflow-manuscript)
