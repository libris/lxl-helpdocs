...
### Inledning
Varje beskrivning i Libris katalogisering innehåller ett avsnitt med Adminmetadata, det vill säga administrativ metadata om beskrivningen. . Denna hjälptext beskriver de vanligaste egenskaperna under Adminmetadata i en instansbeskrivning, till exempel beskrivningens ID, när och av vem den är skapad och dess status. För Adminmetadata i agentbeskrivning, se Hjälptexter Agenter. För Adminmetadata i beståndspost, se Hjälptexter Bestånd. 
