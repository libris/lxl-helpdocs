...
* Flera år (faksimil)  
  Använd Omtryck/återutgivning och originalutgivning i stället för Primär utgivning. Lägg till Plats, Land, Agent, Datum samt Årtal för ursprunglig utgivning och Årtal för ny utgivning.    
